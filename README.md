...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/grayskull-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/grayskull-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add grayskull greyskull
# for installing globally
pixi global install grayskull greyskull
```
...
It is possible to list all of the versions of `grayskull` available on your platform:
...
```
pixi search grayskull --channel conda-forge
```
